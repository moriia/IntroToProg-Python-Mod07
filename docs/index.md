...
![Figure 1. Importing a pickle library.](./images/png1.png)
...
![Figure 2. Beginning of the script file with a header, imports, and variable declaration.  ](./images/png2.png)
...
![Figure 3. Main Body of Script.](./images/png3.png)
...
![ 5. The function to load and display the data existing in the file](./images/png5.png)
...
![Figure 6. The function’get_user_choice’ ask for the user input and returns it](./images/png6.png)
...
![ Figure 7. The function ‘add new row’ which adds the new item to the existing list of items](./images/png7.png)
...
![Figure 8. The function ‘edit_person_salary’ edits the salary of the person, according to the user's choice](./images/png8.png)
...
![Figure 9. The function ‘display_data’ displays existing items to the user.](./images/png9.png)
...
![Figure 10. Function ‘save_data_to_the_file’ writes data to the file.](./images/png10.png)
...
![Figure 11. The function ‘exit_program’ closes the program.](./images/png11.png)
...
![Figure 12.  An example of syntax error.](./images/png12.png)
...
![Figure 13.FileNotFoundError - example for the exception.](./images/png13.png)
...
![Figure 14.ValidationErrorOfUserChoice custom made an exception.](./images/png14.png)
...
![Figure 15.Raise and catch ValidationErrorOfUserChoice extension.](./images/png15.png)

**Figure 15**. Raise and catch ValidationErrorOfUserChoice extension.

![Figure 16.Example of error message showing after extension happened.](./images/png16.png)
...
![Figure 17.Result of the running script in the PyCharm.](./images/png17.png)

**Figure 17**. Result of the running script in the PyCharm.

After I run the program in the terminal (**Figure 18**).

![Figure 18. Result of the running script in Terminal.](./images/png18.png)
...
![Figure 19. Result of running the script, the data is saved in the file.](./images/png19.png)
